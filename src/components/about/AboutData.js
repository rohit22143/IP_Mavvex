import About from '../img/img1.png'
import Contact from '../img/img3.png'
import Career from '../img/img2.png'
...
export const AboutData = {
    ...
    title: "About Us",
    img:About,
    shortDescription:'AI based consultancy and product development enterprise offering services to build deep technology based products for a variety of domains including healthcare, agriculture and retail.',
  ...
  contact:{
    ...
    title: "Contact Us",
    img : Contact,
    shortDescription:'Managing and Enabling Data Privacy in Machine Learning Model.',
  ...
  career:{
    ...
    title: "Career",
    img:Career,
    shortDescription:'Working and providing Better Language Transcription and Translation Services.',
